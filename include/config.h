...
#define SENSOR_TASK_STACK   8192    // Tamaño de pila en bytes (8KB)
...
#define DISPLAY_TASK_STACK      8192     // Tamaño de pila en bytes (8KB)
...
#define ALERT_TASK_STACK     8192 // 8KB de pila
...
#define STORAGE_TASK_STACK      8192     // Tamaño de pila en bytes (8KB)
...
#define ANALYSIS_TASK_STACK     16384    // Tamaño de pila en bytes (16KB) - necesita más memoria

// ============================================================
// CONFIGURACIÓN DE LA TAREA WEB (WebServerTask)
// ============================================================
#define WEB_TASK_PRIORITY       2        // Prioridad media (2)
#define WEB_TASK_STACK          16384    // Tamaño de pila (16KB) - necesita más memoria
#define WEB_SERVER_PORT         80       // Puerto del servidor web

// ============================================================
// CONFIGURACIÓN DE ACCESO PUNTO (ACCESS POINT)
// ============================================================
